...
export function HoverBackArrow({ className = "" }: { className?: string }) {
  return (
    ...
    >
      ...
      <span className="absolute inset-0 flex items-center justify-center translate-x-[110%] transition-transform duration-300 ease-in group-hover:translate-x-0 group-active:translate-x-0">
        <span className="inline-block -rotate-[135deg]">↗</span>
      </span>
    </span>
  );
